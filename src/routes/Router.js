...
const BasicTable2 = lazy(() => import("../views/tables/BasicTable2.js"));
const BasicTable3 = lazy(() => import("../views/tables/BasicTable3.js"));
...
const ThemeRoutes = [
  {
    ...
    children: [
      ...
      { path: "tables/basic-table2", element: <BasicTable2 /> },
      { path: "tables/basic-table3", element: <BasicTable3 /> },
